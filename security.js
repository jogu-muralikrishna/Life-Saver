...
function ensureSOSModal() {
    ...
    modal.onclick = function(e) { if (e.target === modal) toggleSOS(); };
    ...
    if (!modal.dataset.sosFull) {
        modal.innerHTML = `
            <div class="bg-white dark:bg-slate-900 text-slate-900 dark:text-white w-full max-w-lg rounded-3xl p-5 sm:p-7 border-2 border-red-500 dark:border-red-600 shadow-2xl relative my-2 sm:my-6 animate-fade-in">
                <!-- Close Button -->
                <button type="button" onclick="toggleSOS()" class="absolute top-4 right-4 sm:top-5 sm:right-5 text-slate-400 hover:text-slate-700 dark:hover:text-white p-1.5 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 transition font-black text-base z-10" title="Close SOS Dialog">✕</button>
                ...
                <div class="space-y-2.5">
                    ...
                    <button type="button" onclick="toggleSOS()" class="w-full bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 font-bold py-2.5 rounded-xl text-xs transition mt-1">
                        Close Emergency SOS
                    </button>
                </div>
            </div>
